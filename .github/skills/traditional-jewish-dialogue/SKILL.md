---
name: traditional-jewish-dialogue
description: "Use when writing Pokemon Golden Shower NPC dialogue for fictional traditional Jewish characters: Hebrew woven naturally into English, Torah-centered ethical reflection, warm humor, direct conduct-focused correction, and mandatory rotating Hebrew refrains."
argument-hint: "Describe the NPC, scene, gameplay fact, and degree of traditional Jewish voice"
user-invocable: false
disable-model-invocation: true
---

# Traditional Jewish NPC Dialogue

Use this skill for fictional NPCs whose dialogue is rooted in a traditional Jewish outlook. They bring Torah, mitzvot, community, gratitude, study, and responsibility into ordinary life. Their humor may be dry, affectionate, or gently exasperated, but it never makes Jewish identity, Hebrew, or religious practice the joke.

This is a character voice, not a claim about all Jews, all Jewish communities, or the player's real-world beliefs. Let individual NPCs differ in warmth, learning, denomination, patience, and temperament. Do not depict Jewish identity as a source of villainy, greed, manipulation, or mystical power.
...
The speaker values humility, tzedakah, learning, repair, gratitude, honest work, and responsibility toward others and #MON. They may be brisk, wry, or playfully fussy, but the warmth should remain visible. Their correction focuses on pride, vanity, cruelty, dishonesty, neglect, and selfishness, never a protected identity.

Use Hebrew transliterations in standard English characters and supply context through the surrounding English. Favor familiar terms such as `shalom` (peace), `mazel tov` (good fortune), `mitzvah` (a good deed or commandment), `tzedakah` (charity and justice), `chesed` (loving-kindness), `derekh eretz` (decent conduct), `tikkun olam` (repairing the world), `b'ezrat Hashem` (with God's help), and `baruch Hashem` (blessed be God).

Use English that is direct, warm, and specific. Do not force Yiddish spellings, invented Hebrew, fake quotations, or a generic comic accent. When quoting or closely paraphrasing a Jewish text, verify wording and citation; otherwise use a plain moral reflection.
...
- `Mitzvah gedolah, dingleberry. Bad trainers neglect their #MON. Do one good deed today.`
...
The speaker may say that prideful, cruel, bad, or sinful trainers are unfit for a battle in that character's moral view, but never make conduct-based judgment a new gameplay gate. Do not deny access, rewards, safety, friendship, or story progress based on presumed moral or religious status unless the original script already contains that condition.
...
- Training becomes blameworthy when pursued for pride, spectacle, neglect, cruelty, or hollow status.
- A badge, title, or victory matters less than derekh eretz, chesed, and responsibility.
- #MON are a charge requiring mercy and care, not tools for vanity.
- The NPC calls for humility, tzedakah, study, repair, gratitude, or a better choice.
...
Preserve required directions, items, rewards, battle conditions, choices, service outcomes, and event-state facts. Put the actionable fact in a direct clause, then frame it through the NPC's traditional Jewish outlook.
